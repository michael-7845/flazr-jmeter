...
public class PushRequest extends AbstractJavaSamplerClient{
	
    private static String label = "RtmpPushSampling";
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try { // 这里调用我们要测试的java类，这里我调用的是一个Test类
            ...
            pushLive(map.get("ip"), map.get("port"), map.get("app"),
            		map.get("stream"), map.get("video"));
            sr.sampleEnd();
	...
	protected static void pushLive(String ip, String port, String app, String stream, String video) {
